...
$table_text = get_option( 'yith_woocompare_table_text', __( 'Compare products', 'bakan' ) );
...
<head>
	...
	<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/style-compare.css" type="text/css"/> <?php // phpcs:ignore ?>
...
<h1>
	...
	if ( ! $is_iframe ) :
		?>
		<a class="close" href="#"><?php esc_html_e( 'Close window [X]', 'bakan' ); ?></a><?php endif; ?>
</h1>
	...
	>
		...
		<?php if ( empty( $products ) ) : ?>
			...
			<tr class="no-products">
				<td><?php esc_html_e( 'No products added in the compare table.', 'bakan' ); ?></td>
			</tr>
			...
			<tr class="remove">
				...
				foreach ( $products as $product_id => $product ) :
					...
					<td class="<?php echo esc_attr( $product_class ); ?>">
						...
						?>
						"
								data-product_id="<?php echo esc_attr( $product_id ); ?>"><?php esc_html_e( 'Remove', 'bakan' ); ?>
