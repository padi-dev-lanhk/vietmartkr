	...
	class sw_bundle_product_slider_widget extends WP_Widget { 
		...
		**/
		...
		public function widget( $args, $instance ) {
			...
			if ( !empty( $title ) && !empty( $description1 ) ) { 
				echo ent2ncr( $before_title . $title . $after_title . '<h5 class="category_description clearfix">' . $description1 . '</h5>' ); 
			}
			else if (!empty( $title ) && $description1==NULL ){ echo ent2ncr( $before_title . $title . $after_title ); }
		...
		public function form( $instance ) {
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('title1') ); ?>"><?php _e('Title', 'sw_product_bundles')?></label>
				<br />
				<input class="widefat" id="<?php echo esc_attr($this->get_field_id('title1') ); ?>" name="<?php echo esc_attr($this->get_field_name('title1') ); ?>"
					type="text"	value="<?php echo esc_attr($title1); ?>" />
			</p>
			
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('title_length') ); ?>"><?php _e('Product Title Length', 'sw_product_bundles')?></label>
				<br />
				<input class="widefat" id="<?php echo esc_attr($this->get_field_id('title_length') ); ?>" name="<?php echo esc_attr($this->get_field_name('title_length') ); ?>"
					type="text"	value="<?php echo esc_attr($title_length); ?>" />
			</p>
			
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('description1') ); ?>"><?php _e('Description', 'sw_product_bundles')?></label>
				<br />
				<input class="widefat" id="<?php echo esc_attr($this->get_field_id('description1') ); ?>" name="<?php echo esc_attr($this->get_field_name('description1') ); ?>"
					type="text"	value="<?php echo esc_attr($description1); ?>" />
			</p>
			
			<p id="wgd-<?php echo esc_attr($this->get_field_id('category') ); ?>">
				<label for="<?php echo esc_attr($this->get_field_id('category')); ?>"><?php _e('Category', 'sw_product_bundles')?></label>
				<br />
				<?php echo esc_attr($this->category_select('category', array('allow_select_all' => true), $categoryid) ); ?>
			</p>	
			
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('orderby')); ?>"><?php _e('Orderby', 'sw_product_bundles')?></label>
				<br />
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('order')); ?>"><?php _e('Order', 'sw_product_bundles')?></label>
				<br />
				<select class="widefat"
					id="<?php echo esc_attr($this->get_field_id('order')); ?>" name="<?php echo esc_attr($this->get_field_name('order')); ?>">
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('numberposts') ); ?>"><?php _e('Number of Posts', 'sw_product_bundles')?></label>
				<br />
				<input class="widefat" id="<?php echo esc_attr($this->get_field_id('numberposts')); ?>" name="<?php echo esc_attr($this->get_field_name('numberposts')); ?>"
					type="text"	value="<?php echo esc_attr($number); ?>" />
			</p>

			<p>
				<label for="<?php echo esc_attr($this->get_field_id('length')); ?>"><?php _e('Excerpt length (in words): ', 'sw_product_bundles')?></label>
				<br />
				<input class="widefat"
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('item_row')); ?>"><?php _e('Number row per column:  ', 'sw_product_bundles')?></label>
				<br />
				<select class="widefat"
					id="<?php echo esc_attr($this->get_field_id('item_row')); ?>"
					name="<?php echo esc_attr($this->get_field_name('item_row')); ?>">
					<?php
					$option ='';
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('columns')); ?>"><?php _e('Number of Columns >1200px: ', 'sw_product_bundles')?></label>
				<br />
				<select class="widefat"
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('columns1')); ?>"><?php _e('Number of Columns on 992px to 1199px: ', 'sw_product_bundles')?></label>
				<br />
				<select class="widefat"
					id="<?php echo esc_attr($this->get_field_id('columns1')); ?>"
					name="<?php echo esc_attr($this->get_field_name('columns1')); ?>">
					<?php
					$option ='';
					foreach ($number as $key => $value) :
						$option .= '<option value="' . $value . '" ';
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('columns2')); ?>"><?php _e('Number of Columns on 768px to 991px: ', 'sw_product_bundles')?></label>
				<br />
				<select class="widefat"
					id="<?php echo esc_attr($this->get_field_id('columns2')); ?>"
					name="<?php echo esc_attr($this->get_field_name('columns2')); ?>">
					<?php
					$option ='';
					foreach ($number as $key => $value) :
						$option .= '<option value="' . $value . '" ';
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('columns3')); ?>"><?php _e('Number of Columns on 480px to 767px: ', 'sw_product_bundles')?></label>
				<br />
				<select class="widefat"
					id="<?php echo esc_attr($this->get_field_id('columns3')); ?>"
					name="<?php echo esc_attr($this->get_field_name('columns3')); ?>">
					<?php
					$option ='';
					foreach ($number as $key => $value) :
						$option .= '<option value="' . $value . '" ';
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('columns4')); ?>"><?php _e('Number of Columns in 480px or less than: ', 'sw_product_bundles')?></label>
				<br />
				<select class="widefat"
					id="<?php echo esc_attr($this->get_field_id('columns4')); ?>"
					name="<?php echo esc_attr($this->get_field_name('columns4')); ?>">
					<?php
					$option ='';
					foreach ($number as $key => $value) :
						$option .= '<option value="' . $value . '" ';
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('autoplay')); ?>"><?php _e('Auto Play', 'sw_product_bundles')?></label>
				<br />
				<select class="widefat"
					id="<?php echo esc_attr($this->get_field_id('autoplay')); ?>" name="<?php echo esc_attr($this->get_field_name('autoplay')); ?>">
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('interval')); ?>"><?php _e('Interval', 'sw_product_bundles')?></label>
				<br />
				<input class="widefat" id="<?php echo esc_attr($this->get_field_id('interval')); ?>" name="<?php echo esc_attr($this->get_field_name('interval')); ?>"
					type="text"	value="<?php echo esc_attr($interval); ?>" />
			</p>
			
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('speed')); ?>"><?php _e('Speed', 'sw_product_bundles')?></label>
				<br />
				<input class="widefat" id="<?php echo esc_attr($this->get_field_id('speed')); ?>" name="<?php echo esc_attr($this->get_field_name('speed')); ?>"
					type="text"	value="<?php echo esc_attr($speed); ?>" />
			</p>
			
			
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('scroll')); ?>"><?php _e('Total Items Slided', 'sw_product_bundles')?></label>
				<br />
				<input class="widefat" id="<?php echo esc_attr($this->get_field_id('scroll')); ?>" name="<?php echo esc_attr($this->get_field_name('scroll')); ?>"
					type="text"	value="<?php echo esc_attr($scroll); ?>" />
			</p>
			
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('widget_template')); ?>"><?php _e("Template", 'sw_product_bundles')?></label>
				<br/>
				
				<select class="widefat"
					id="<?php echo esc_attr($this->get_field_id('widget_template')); ?>"	name="<?php echo esc_attr($this->get_field_name('widget_template')); ?>">
					<option value="combo" <?php if ($widget_template=='combo'){?> selected="selected"
					<?php } ?>>
						<?php _e('Default', 'sw_product_bundles')?>		
					</option>
					<option value="hotcombo" <?php if ($widget_template=='hotcombo'){?> selected="selected"
					<?php } ?>>
						<?php _e('Hot combo', 'sw_product_bundles')?>		
					</option>					
				</select>
			</p>  
		<?php
