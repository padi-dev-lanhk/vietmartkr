...
if ( $list -> have_posts() ){ ?>
	<div id="<?php echo esc_attr($category.'_'.$id); ?>" class="sw-woo-container-slider  bundle-slider style-hotcombo" >
										...
										<div class="item-thumbnail-product">
											...
											<div class="boxinfo-wrapper">
												...
												<?php if( $bundle->get_type() == "variation" ) : ?>			
												 ...
												 <?php else: ?>
												 <a href="<?php echo esc_url( $product_url ); ?>"><?php echo esc_html( $bundle->get_title() );?></a>
												 <?php endif; ?>
	                                            </div>
