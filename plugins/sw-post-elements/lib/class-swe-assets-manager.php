...
final class SWE_Assets_Manager {
    ...
    function _afterRegisterFrontendScripts() {
        wp_register_script('swe-script', SWPE_PLUGIN_URI.'assets/js/script.js', ['jquery-core'], Plugin::VERSION, true);
        wp_register_script('slick', SWPE_PLUGIN_URI.'assets/vendor/slick/slick.min.js', ['jquery-core'], Plugin::VERSION, true);
        wp_register_script('countdown', SWPE_PLUGIN_URI.'assets/vendor/countdown/countdown.js', ['jquery-core'], Plugin::VERSION, true);
        wp_register_script('infinite', SWPE_PLUGIN_URI.'assets/vendor/infinite-scroll/infinite-scroll.pkgd.min.js', ['jquery-core'], '3.0.5', true);
        wp_register_script('isotope', SWPE_PLUGIN_URI.'assets/vendor/isotope/isotope.pkgd.min.js', ['jquery-core'], Plugin::VERSION, true);
    }
    ...
    function _afterEnqueueFrontendStyles() {
        wp_register_style('slick', SWPE_PLUGIN_URI . 'assets/vendor/slick/slick.css', [], Plugin::VERSION);
        wp_enqueue_style('swe-style', SWPE_PLUGIN_URI . 'assets/scss/style.css', [], Plugin::VERSION);
        wp_enqueue_style('font-awesome-5-all', SWPE_PLUGIN_URI . 'assets/vendor/font-awesome/css/all.min.css', [], Plugin::VERSION);
    }
