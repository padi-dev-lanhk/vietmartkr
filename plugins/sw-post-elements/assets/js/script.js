 ...
 (function ($) {
    ...
    $(window).on('elementor/frontend/init', function () {
        ...
        elementorFrontend.hooks.addAction(
		 ...
		 // Post Slider
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/swe-post-slider-layout1.default",
            sw_elements.swe_slider
            );
        ...
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/swe-testimonial-layout1.default",
            sw_elements.swe_slider
            );
		
		// Testimonial Slider Layout2
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/swe-testimonial-layout2.default",
            sw_elements.swe_slider
            );
