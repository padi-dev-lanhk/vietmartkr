...
/**
 * SWE_Category_Tab_Slider
 *
 * @author Youtech
 * @package SWE
 */

final class SWE_Category_Tab_Slider extends SWE_Widget_Base {
    /**
     * @return string
     */
    function get_name() {
        return 'swe-category-tab-slider';
    }
     ...
     */
    function get_title() {
        return esc_html__('SWE Category Tab Slider', 'sw-post-elements');
    }
    ...
    public function register_controls() {
        ...
        */
        ...
        $this->add_control( 'title', [
            ...
            'label_block' => true,
            'default'     => esc_html__( 'Category Tab Slider', 'sw-post-elements' ),
        ]);

        $this->add_control( 'tabs_style', [
            'label' => esc_html__( 'Tabs Style', 'sw-post-elements' ),
        ...
        $this->add_control('tabs_button', [
            ...
            'description' => esc_html__('Button replaces tabs to display across screens', 'sw-post-elements'),
            'type' => Controls_Manager::SELECT,
            'options' => [
                '' => esc_html__('None', 'sw-post-elements'),
                'btn-mobile' => esc_html__('Mobile', 'sw-post-elements'),
                'btn-tablet' => esc_html__('Tablet', 'sw-post-elements'),
                'btn-desktop' => esc_html__('Desktop', 'sw-post-elements'),
            ],
            'default' => 'btn-mobile',
        ]);
        ...
        */
        ...
        $this->add_control( 'post_cats', [
            ...
            'multiple' => true,
            'label_block' => true,
            'options' => $this->get_post_categories(2),
        ]);
        ...
        */
        ...
        /**
        * Style wrap title head
        */
        $this->start_controls_section( 'section_style_wrap_title_head', [
            'label' => esc_html__( 'Title Head', 'sw-post-elements' ),
            'tab'   => Controls_Manager::TAB_STYLE,
            'condition' => [
                'title!' => ''
            ]
        ...
        $this->add_responsive_control( 'wrap_title_head_position', [
    ...
    protected function render() {
        ...
        $this->getViewTemplate('template', 'category-tab-slider', $settings);
    }
}

ElementorPlugin::instance()->widgets_manager->register(new SWE_Category_Tab_Slider());
