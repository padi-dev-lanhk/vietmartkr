...
/**
 * SWE_Testimonial_Layout2
 *
 * @author Youtech
 * @package SWE
 */

final class SWE_Testimonial_Layout2 extends SWE_Widget_Base {
    /**
     * @return string
     */
    function get_name() {
        return 'swe-testimonial-layout2';
    }
     ...
     */
    function get_title() {
        return esc_html__('SWE Testimonial Layout2', 'sw-post-elements');
    }
        ...
        */
        ...
        $this->add_responsive_control('wrap_avatar_space', [
            ...
            'selectors'  => [
                ...
                '{{WRAPPER}} .style-2 .swe-avatar' => 'margin-right: 0;margin-bottom: {{SIZE}}{{UNIT}};',
            ],
        ]);
    ...
    protected function render() {
        ...
        $this->getViewTemplate('template', 'testimonial-layout2', $settings);
    }
}

ElementorPlugin::instance()->widgets_manager->register(new SWE_Testimonial_Layout2());
