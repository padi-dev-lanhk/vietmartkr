...
final class SWE_Post_Slider extends SWE_Widget_Base {
    /**
     * @return string
     */
    function get_name() {
        return 'swe-post-slider';
    }
     ...
     */
    function get_title() {
        return esc_html__('SWE Post Slider', 'sw-post-elements');
    }
    ...
    protected function render() {
        ...
        $this->getViewTemplate('template', 'post-slider', $settings);
    }
}

ElementorPlugin::instance()->widgets_manager->register(new SWE_Post_Slider());
