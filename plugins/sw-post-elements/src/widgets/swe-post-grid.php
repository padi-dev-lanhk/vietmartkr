...
final class SWE_Post_Grid extends SWE_Widget_Base {
    /**
     * @return string
     */
    function get_name() {
        return 'swe-post-grid';
    }
     ...
     */
    function get_title() {
        return esc_html__('SWE Post Grid', 'sw-post-elements');
    }
    ...
    public function get_script_depends() {
        return [ 'slick', 'infinite', 'swe-script' ];
    }
    ...
    public function register_controls() {
        ...
        */
        ...
        $this->add_control('columns', [
            'label' => esc_html__( 'Columns for row', 'sw-post-elements' ),
        ...
        $this->add_control('columns_tablet', [
            'label' => esc_html__( 'Columns for row on tablet', 'sw-post-elements' ),
            'type' => Controls_Manager::SLIDER,
            'range' => [
                'px' => [
                    'min' => 1,
        ...
        $this->add_control('columns_mobile', [
            'label' => esc_html__( 'Columns for row on mobile', 'sw-post-elements' ),
            'type' => Controls_Manager::SLIDER,
            'range' => [
                'px' => [
                    'min' => 1,
        ...
        $this->add_responsive_control('grid_space_items', [
            ...
            'selectors' => [
                '{{WRAPPER}} .posts' => 'margin: 0 calc(-{{SIZE}}px/2);',
                '{{WRAPPER}} .posts .post' => 'padding: 0 calc({{SIZE}}px/2);',
            ],
        ]);

        $this->add_responsive_control('grid_space', [
            'label' => esc_html__( 'Space Bottom', 'sw-post-elements' ),
            'type' => Controls_Manager::SLIDER,
            'range' => [
                'px' => [
                    'min' => 0,
            ...
            'selectors' => [
                '{{WRAPPER}} .posts .post' => 'margin-bottom: {{SIZE}}px;',
            ],
        ]);
    ...
    protected function render() {
        ...
        $this->getViewTemplate('template', 'post-grid', $settings);
    }
}

ElementorPlugin::instance()->widgets_manager->register(new SWE_Post_Grid());
