...
/**
 * SWE_Post_Slider_Layout1
 *
 * @author Youtech
 * @package SWE
 */

final class SWE_Post_Slider_Layout1 extends SWE_Widget_Base {
    /**
     * @return string
     */
    function get_name() {
        return 'swe-post-slider-layout1';
    }
     ...
     */
    function get_title() {
        return esc_html__('SWE Post Slider Layout1', 'sw-post-elements');
    }
    ...
    protected function render() {
        ...
        $this->getViewTemplate('template', 'post-slider-layout1', $settings);
    }
}

ElementorPlugin::instance()->widgets_manager->register(new SWE_Post_Slider_Layout1());
