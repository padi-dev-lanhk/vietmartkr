...
final class SWE_Testimonial_Layout1 extends SWE_Widget_Base {
    /**
     * @return string
     */
    function get_name() {
        return 'swe-testimonial-layout1';
    }
     ...
     */
    function get_title() {
        return esc_html__('SWE Testimonial Layout1', 'sw-post-elements');
    }
    ...
    protected function register_controls() {
        ...
        */
		...
		$this->add_responsive_control( 'wrap_content_text_padding', [
            'label'      => esc_html__( 'Padding', 'sw-post-elements' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => [ 'px', '%' ],
            'selectors'  => [
                '{{WRAPPER}} .swe-content .swe-text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
        ]);
        ...
        */
        ...
        $this->add_group_control( Group_Control_Typography::get_type(), [
            ...
            'scheme' => Typography::TYPOGRAPHY_1,
            'selector' => '{{WRAPPER}} .swe-content .swe-description',
        ]);
        ...
        $this->add_control( 'wrap_desc_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .swe-content .swe-description' => 'color: {{VALUE}};',
            ],
        ]);
    ...
    protected function render() {
        ...
        $this->getViewTemplate('template', 'testimonial-layout1', $settings);
    }
}

ElementorPlugin::instance()->widgets_manager->register(new SWE_Testimonial_Layout1());
