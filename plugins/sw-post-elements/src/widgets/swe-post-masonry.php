...
final class SWE_Post_Masonry extends SWE_Widget_Base {
    /**
     * @return string
     */
    function get_name() {
        return 'swe-post-masonry';
    }
     ...
     */
    function get_title() {
        return esc_html__('SWE Post Masonry', 'sw-post-elements');
    }
    ...
    public function get_script_depends() {
        return [ 'slick', 'infinite', 'isotope', 'swe-script' ];
    }
    ...
    protected function render() {
        ...
        $this->getViewTemplate('template', 'post-masonry', $settings);
    }
}

ElementorPlugin::instance()->widgets_manager->register(new SWE_Post_Masonry());
