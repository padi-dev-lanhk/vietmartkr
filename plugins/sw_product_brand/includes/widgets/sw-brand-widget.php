...
class sw_brand_widget extends WP_Widget {
	...
	*/
	...
	public function widget( $args, $instance ) {
		...
		if ( $tpl = swbr_override_check( 'sw-brands', $instance['widget_template'] ) ){ 
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['desciption1'] = strip_tags( $new_instance['desciption1'] );
		// str or array
	...
	public function form( $instance ) {
		...
		$desciption1 	= isset( $instance['desciption1'] )   ? strip_tags($instance['desciption1']) : '';
		...
		<p>
			<label for="<?php echo $this->get_field_id('desciption1'); ?>"><?php _e('Description', 'sw_product_brand')?></label>
			<br />
			<input class="widefat" id="<?php echo $this->get_field_id('desciption1'); ?>" name="<?php echo $this->get_field_name('desciption1'); ?>"
				type="text"	value="<?php echo esc_attr($desciption1); ?>" />
		</p>
		<p>
