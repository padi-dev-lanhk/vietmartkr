...
<?php  $maintaince_attr = ( swg_options( 'maintaince_background' ) != '' ) ? 'style="background: url( '. esc_url( swg_options( 'maintaince_background' ) ) .' )"' : ''; ?>
<body class="sw-maintaince">
	<div class="body-wrapper" <?php echo $maintaince_attr; ?>>
		<div class="header-maintaince">
			<div class="header-logo">
				<div class="container">
					<div class="row">
						<h1>
							<?php $main_logo = swg_options( 'sitelogo' ); ?>
		...
		<div id="main-content" class="main-content">
			<div class="container">
				<div class="page-top">
					<?php echo stripslashes( swg_options( 'maintaince_content' ) ); ?>
				</div>
				<div class="page-bottom">
				
					<div id="countdown-container" class="countdown-container"></div>
					<?php if( swg_options( 'maintaince_form' ) != '' ): ?> 
					<div class="form-subscribers">
						<div class="form-wrap">
							<?php echo do_shortcode( swg_options( 'maintaince_form' ) ); ?>
						</div>
					</div>
					<?php endif; ?>
		...
		<?php $sw_copyright_text = swg_options( 'footer_copyright' );  ?>
		<div class="copyright">
			<address>
