<?php
class SWG_Options_date extends SWG_Options{	
	...
	*/
	function enqueue(){ 
		wp_enqueue_style('sw-opts-jquery-ui-css', SWG_OPTIONS_URL . '/options/css/aristo.css', array(), null);	
		wp_enqueue_script(
			'sw-opts-field-date-js', 
			SWG_OPTIONS_URL.'/options/fields/date/field_date.js', 
