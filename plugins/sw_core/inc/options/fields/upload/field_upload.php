<?php
class SWG_Options_upload extends SWG_Options{
	...
	*/
	function enqueue(){
		...
		wp_enqueue_script(
			'sw-menu-upload-js',
			SWG_OPTIONS_URL.'/options/fields/upload/field_upload.js',
		...
		wp_localize_script('sw-menu-upload-js', 'sw_upload', array('url' => SWG_OPTIONS_URL.'/options/img/default.png'));
