				...
				<div class="item-wrap">
					<div class="item-top clearfix">
						...
						<ul class="social">
							...
							<?php } ?>
							<?php if( $twitter != '' ){ ?>
								<li><a href="<?php echo esc_html( $facebook ); ?>"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
							<?php } ?>
							<?php if( $linkedin != '' ){ ?>
								<li><a href="<?php echo esc_html( $facebook ); ?>"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
							<?php } ?>
						</ul>
					</div>
