	...
	**/
	function OT_Shortcode( $atts, $content = null ){
		...
		if( $layout == 'default' ){
			...
			include( sw_core_override_check( 'sw-ourteam', 'team-style2' ) );
		}
	...
	public function widget( $args, $instance ) {
		...
		if( $instance['widget_template'] == 'default' ){
			include( sw_core_override_check( 'sw-ourteam', 'default' ) );
		}elseif( $instance['widget_template'] == 'team-style1' ){
			include( sw_core_override_check( 'sw-ourteam', 'team-style1' ) );
		}elseif( $instance['widget_template'] == 'team-style2' ){
			include( sw_core_override_check( 'sw-ourteam', 'team-style2' ) );
		}
	...
	public function form( $instance ) {
		...
		<p>
			...
			<select class="widefat"
				...
				<option value="team-style1" <?php if ($widget_template=='team-style1'){?> selected="selected"
				<?php } ?>>
					<?php _e('Theme 1', 'sw_core')?>
				</option>
				<option value="team-style2" <?php if ($widget_template=='team-style2'){?> selected="selected"
				<?php } ?>>
					<?php _e('Theme 2', 'sw_core')?>
				</option>				
			</select>
		</p>               
	<?php
