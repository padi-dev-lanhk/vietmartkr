	...
	protected function layered_nav_list( $terms, $taxonomy, $query_type ) {
		...
		foreach ( $terms as $term ) {
			...
			if ( $count > 0 || $option_is_set ) {
				...
				$term_html = '<a rel="nofollow" href="' . esc_url( $link ) . '" title="'. esc_attr( $term->name ) .'"><span class="style-color"><span '.$attr .'></span></span><span class="name-color">' . esc_attr( $term->name ) . '<span></a>';
			} else {
				$link      = false;
