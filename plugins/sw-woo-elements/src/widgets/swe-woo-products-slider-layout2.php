...
/**
 * SWE_Woo_Category_Tab_Slider Layout2
 *
 * @author Youtech
 * @package SWE
 */
...
if (class_exists('WooCommerce')) {
    final class SWE_Woo_Products_Slider_Layout2 extends SWE_Widget_Base {
        /**
         * @return string
         */
        function get_name() {
            return 'swe-woo-products-slider-layout2';
        }
         ...
         */
        function get_title() {
            return esc_html__('SWE Woo Products Slider Layout2', 'sw-woo-elements');
        }
        ...
        public function register_controls() {
            ...
            */
            ...
            $this->add_control( 'title', [
                ...
                'label_block' => true,
                'default'     => __( 'Woo Products Slider', 'sw-woo-elements' ),
            ]);
			...
			$this->add_control('layout_style', [
                ...
                'options' => [
                    ...
                    'style-4' => __('Style 4', 'sw-woo-elements'),
                    'style-5' => __('Style 5', 'sw-woo-elements'),
                    'style-6' => __('Style 6', 'sw-woo-elements'),
                ],
                'default' => 'style-1'
            ]);
			
			$this->add_control( 'show_banner', [
                'label' => __( 'Show Banner', 'sw-woo-elements' ),
                'description' => __('Display Banner of product category', 'sw-woo-elements'),
            ...
            */
			...
			$this->add_responsive_control( 'center_mode', [
                'label' => __( 'Center Mode', 'sw-woo-elements' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __( 'ON', 'sw-woo-elements' ),
                'label_off' => __( 'OFF', 'sw-woo-elements' ),
                'return_value' => 'yes',
                'default' => 'yes',
            ]);
			...
			*/
			...
			$this->start_controls_section( 'banner_config', [
				'label' => __( 'Banner Settings', 'sw-woo-elements' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]);
            ...
            * Button Config
            */
            $this->start_controls_section( 'button_config', [
                'label' => __( 'Button', 'sw-woo-elements' ),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]);
			
			$this->add_control( 'show_button', [
                'label' => __( 'Show Button', 'sw-woo-elements' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __( 'Show', 'sw-woo-elements' ),
                'label_off' => __( 'Hide', 'sw-woo-elements' ),
                'return_value' => 'yes',
            ...
            */
			...
			$this->start_controls_section( 'section_style_banner_title', [
                'label' => __( 'Banner', 'sw-woo-elements' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'title!' => ''
                ]
			...
			$this->add_responsive_control( 'wrap_banner_padding', [
                'label'      => __( 'Padding', 'sw-woo-elements' ),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%' ],
                'selectors'  => [
                    '{{WRAPPER}} .swe-wraps-image' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]);
			 $this->end_controls_section();
            /**
            ...
            */
			...
			$this->add_responsive_control(
				'arrows_border_width',
				[
					'label' => esc_html__( 'Width', 'sw-woo-elements' ),
					'type' => Controls_Manager::DIMENSIONS,
					'size_units' => [ 'px', 'em', '%' ],
					'selectors' => [
						'{{WRAPPER}} .swe-slider .swe-slider-btn' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
					'condition' => [
						'arrows_border_width!' => 'none',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}}' => '.swe-slider .swe-slider-btn: {{VALUE}};',
					],
					'condition' => [
						'arrows_border_color!' => 'none',
					],
				]
			);
            ...
            $this->add_responsive_control(
				...
				[
					...
					'condition' => [
						'arrows_border_width_hover!' => 'none',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'condition' => [
						'arrows_border_color_hover!' => 'none',
					],
				]
			);
			...
			*/
			...
			$this->add_responsive_control( 'wrap_button_position', [
                'label'                => __( 'Position', 'sw-woo-elements' ),
                'type'                 => Controls_Manager::CHOOSE,
                'label_block'          => false,
                'options'              => $this->getOptionPosition('hor'),
                'selectors'            => [
                    '{{WRAPPER}} .swe-button-wrap' => '{{VALUE}}',
                ],
                'selectors_dictionary' => [
                    'left'   => 'justify-content: flex-start;',
                    'center' => 'justify-content: center;',
        ...
        protected function render() {
            ...
            $this->add_render_attribute( 'slider_options', [
				...
				'data-center_mode' => $settings[ 'center_mode' ],
                'data-center_mode_tablet' => isset($settings[ 'center_mode_tablet' ]),
                'data-center_mode_mobile' => isset($settings[ 'center_mode_mobile' ]),
            ...
            $this->getViewTemplate('template', 'woo-products-slider-layout2', $settings);
        }
    }

    ElementorPlugin::instance()->widgets_manager->register(new SWE_Woo_Products_Slider_Layout2());
}