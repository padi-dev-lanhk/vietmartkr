...
if (class_exists('WooCommerce')) {
    final class SWE_Woo_Categories_Slider extends SWE_Widget_Base {
        /**
         * @return string
         */
        function get_name() {
            return 'swe-woo-categories-slider';
        }
         ...
         */
        function get_title() {
            return esc_html__('SWE Woo Categories Slider', 'sw-woo-elements');
        }
        ...
        public function register_controls() {
            ...
            */
            ...
            $this->add_control( 'show_image', [
                ...
                'description' => __('Display thumbnail of product category', 'sw-woo-elements'),
            ...
            */
			...
			$this->add_control( 'wrap_content_background', [
                'label' => __( 'Background', 'sw-woo-elements' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .swe-wrap-item' => 'background: {{VALUE}};',
        ...
        protected function render() {
            ...
            $this->getViewTemplate('template', 'woo-categories-slider', $settings);
        }
    }

    ElementorPlugin::instance()->widgets_manager->register(new SWE_Woo_Categories_Slider());
}
