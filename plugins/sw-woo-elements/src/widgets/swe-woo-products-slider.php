...
if (class_exists('WooCommerce')) {
    final class SWE_Woo_Products_Slider extends SWE_Widget_Base {
        /**
         * @return string
         */
        function get_name() {
            return 'swe-woo-products-slider';
        }
         ...
         */
        function get_title() {
            return esc_html__('SWE Woo Products Slider', 'sw-woo-elements');
        }
        ...
        protected function render() {
            ...
            $this->getViewTemplate('template', 'woo-products-slider', $settings);
        }
    }

    ElementorPlugin::instance()->widgets_manager->register(new SWE_Woo_Products_Slider());
}