...
/**
 * SWE_Woo_Countdown_Slider_Layout3
 *
 * @author Youtech
 * @package SWE
 */
...
if (class_exists('WooCommerce')) {
    final class SWE_Woo_Countdown_Slider_Layout3 extends SWE_Widget_Base {
        /**
         * @return string
         */
        function get_name() {
            return 'swe-woo-countdown-slider-layout3';
        }
         ...
         */
        function get_title() {
            return esc_html__('SWE Woo Countdown Slider Layout3', 'sw-woo-elements');
        }
        ...
        protected function render() {
            ...
            $this->getViewTemplate('template', 'woo-countdown-slider-layout3', $settings);
        }
    }

    ElementorPlugin::instance()->widgets_manager->register(new SWE_Woo_Countdown_Slider_Layout3());
}