...
if ( class_exists('WooCommerce') ) {
    final class SWE_Woo_Recent_Viewed extends SWE_Widget_Base {
        /**
         * @return string
         */
        function get_name() {
            return 'swe-woo-recent-viewed';
        }
         ...
         */
        function get_title() {
            return esc_html__('SWE Woo Recent Viewed', 'sw-woo-elements');
        }
        ...
        public function register_controls() {
            ...
            */
            ...
            $this->add_control( 'title', [
                ...
                'label_block' => true,
                'default'     => __( 'Recent Viewed', 'sw-woo-elements' ),
            ]);
        ...
        protected function render() {
            ...
            $this->getViewTemplate('template', 'woo-recent-viewed', $settings);
        }
    }

    ElementorPlugin::instance()->widgets_manager->register(new SWE_Woo_Recent_Viewed());
}
