...
if (class_exists('WooCommerce')) {
    final class SWE_Woo_Categories_Slider_Layout1 extends SWE_Widget_Base {
        /**
         * @return string
         */
        function get_name() {
            return 'swe-woo-categories-slider-layout1';
        }
         ...
         */
        function get_title() {
            return esc_html__('SWE Woo Categories Slider Layout1', 'sw-woo-elements');
        }
        ...
        public function register_controls() {
			...
			*/
			...
			$this->add_control( 'image2', [
				'label' => __( 'Image 2', 'sw-woo-elements' ),
				'type' => Controls_Manager::MEDIA,
				'default' => [
					'url' => Utils::get_placeholder_image_src(),
				],
			...
			$this->add_control( 'image3', [
				'label' => __( 'Image 3', 'sw-woo-elements' ),
				'type' => Controls_Manager::MEDIA,
				'default' => [
					'url' => Utils::get_placeholder_image_src(),
				],
            ...
            */
            ...
            $this->add_group_control( Group_Control_Typography::get_type(), [
                ...
                'scheme' => Typography::TYPOGRAPHY_1,
                'selector' => '{{WRAPPER}} .swe-title-cat, {{WRAPPER}} .swe-title-cat a',
            ]);
            ...
            $this->add_control( 'wrap_title_color_child_cat', [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .swe-title-cat a' => 'color: {{VALUE}};',
                ],
            ]);
            ...
            $this->add_control( 'wrap_title_child_cat_color_hover', [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .swe-title-cat a:hover' => 'color: {{VALUE}};',
                ],
            ]);
            ...
            $this->add_responsive_control( 'wrap_title_padding_child_cat', [
                ...
                'size_units' => [ 'px', '%' ],
                'selectors'  => [
                    '{{WRAPPER}} .swe-wrap-content .swe-title-cat' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]);
            ...
            $this->add_responsive_control( 'wrap_title_margin_child_cat', [
                ...
                'size_units' => [ 'px', '%' ],
                'selectors'  => [
                    '{{WRAPPER}} .swe-wrap-content .swe-title-cat' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]);
        ...
        protected function render() {
            ...
            $this->getViewTemplate('template', 'woo-categories-slider-layout1', $settings);
        }
    }

    ElementorPlugin::instance()->widgets_manager->register(new SWE_Woo_Categories_Slider_Layout1());
}
