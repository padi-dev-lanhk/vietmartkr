...
if (class_exists('WooCommerce')) {
    final class SWE_Woo_Products_Slider_Layout1 extends SWE_Widget_Base {
        /**
         * @return string
         */
        function get_name() {
            return 'swe-woo-products-slider-layout1';
        }
         ...
         */
        function get_title() {
            return esc_html__('SWE Woo Products Slider Layout1', 'sw-woo-elements');
        }
        ...
        protected function render() {
            ...
            $this->add_render_attribute( 'slider_options', [
                ...
                'data-center_mode_tablet' => $settings[ 'center_mode_tablet' ],
                'data-center_mode_mobile' => $settings[ 'center_mode_mobile' ],
            ...
            $this->getViewTemplate('template', 'woo-products-slider-layout1', $settings);
        }
    }

    ElementorPlugin::instance()->widgets_manager->register(new SWE_Woo_Products_Slider_Layout1());
}