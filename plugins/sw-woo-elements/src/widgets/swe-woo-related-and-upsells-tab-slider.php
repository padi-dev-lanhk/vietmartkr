...
/**
 * SWE_Woo_Related_And_Upsells_Tab_Slider
 *
 * @author Youtech
 * @package SWE
 */
...
if ( class_exists('WooCommerce') ) {
    final class SWE_Woo_Related_And_Upsells_Tab_Slider extends SWE_Widget_Base {
        /**
         * @return string
         */
        function get_name() {
            return 'swe-woo-related-and-upsells-tab-slider';
        }
         ...
         */
        function get_title() {
            return esc_html__('SWE Woo Related And Upsells Tab Slider', 'sw-woo-elements');
        }
        ...
        public function register_controls() {
            ...
            */
            ...
            $this->add_control( 'tabs', [
                'label' => __( 'Tab', 'sw-woo-elements' ),
                'type' => Controls_Manager::SELECT2,
                'multiple' => true,
                'label_block' => true,
                'options' => [
                    'related' => __('Related', 'sw-woo-elements'),
                    'upsells' => __('Upsells', 'sw-woo-elements'),
                ],
                'default' => [ 'related', 'upsells' ]
            ]);

            $this->add_control( 'text_related', [
                'label' => esc_html__('Title Related', 'sw-woo-elements'),
            ...
            $this->add_control( 'text_upsells', [
                'label' => esc_html__('Title Upsells', 'sw-woo-elements'),
                'description' => esc_html__('', 'sw-woo-elements'),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default'     => __( 'Upsell Products', 'sw-woo-elements' ),
            ]);
        ...
        protected function render() {
            ...
            $this->getViewTemplate('template', 'woo-related-and-upsells-tab-slider', $settings);
        }
    }

    ElementorPlugin::instance()->widgets_manager->register(new SWE_Woo_Related_And_Upsells_Tab_Slider());
}
