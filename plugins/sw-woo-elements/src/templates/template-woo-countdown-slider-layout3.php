<?php 
/**
 * View template for SWE Woo Countdown Slider
 *
 * @package SWE\Templates
 * @copyright 2021 SW Elements. All rights reserved.
 */

$sweWrap = 'swe-woo-countdown-slider-layout3 swe-wrapper';
		...
		<?php if( $products->have_posts() ) {
			while($products->have_posts()){ $products->the_post();
				...
				<li <?php wc_product_class( 'item', $product ); ?>>
					<div class="products-entry item-wrap3 clearfix">
						<div class="item-detail">
							...
							<div class="item-content products-content">
								<?php if ($settings && $settings['show_countdown'] == 'top') { ?>
