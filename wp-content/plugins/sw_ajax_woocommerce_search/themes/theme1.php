...
<div class="search-cate pull-right">
	...
	<div class="sw_top swsearch-wrapper clearfix">
			...
			<div class="topsearch-entry">
				...
				<div id="<?php echo esc_attr( $id_widget ); ?>" class="search input-group" 
					...
					<div class="content-search">
						<input class="autosearch-input" type="text" value="<?php echo ( ( isset( $_GET['s'] ) && $_GET['s'] ) ? ( $_GET['s'] ) : "" ); ?>" size="50" autocomplete="off" placeholder="<?php echo esc_attr__( 'Enter your keyword...', 'sw_ajax_woocommerce_search' ); ?>" name="s">	
