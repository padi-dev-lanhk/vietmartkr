					...
					<div id="meta_datas_list">
						...
						<div id="mdl_group_wc" class="mdl_group_wrap" data-title="<?php _e('WooCommerce', 'revslider');?>">
							...
							<div class="mdl_group">
								...
								<div data-val="{{wc_add_to_cart_button}}" class="mdl_group_member"><div class="mdl_left_content"><i class="material-icons">category</i><?php _e("Add to Cart Button", 'revslider');?></div><div class="mdl_right_content">{{wc_add_to_cart_button}}</div><div class="mdl_placeholder_content"><?php _e('Thêm vào giỏ hàng', 'revslider');?></div></div>
							</div>
							<div class="mdl_group">
