...
/**
 * SWE_Post_Recently_Viewed
 *
 * @author Youtech
 * @package SWE
 */

final class SWE_Post_Recently_Viewed extends SWE_Widget_Base {
    /**
     * @return string
     */
    function get_name() {
        return 'swe-post-recently-viewed';
    }
     ...
     */
    function get_title() {
        return esc_html__('SWE Post Recently Viewed', 'sw-post-elements');
    }
    ...
    public function register_controls() {
        ...
        */
        ...
        $this->add_control( 'title', [
            ...
            'label_block' => true,
            'default'     => esc_html__( 'Recently Viewed', 'sw-post-elements' ),
        ]);
    ...
    protected function render() {
        ...
        $this->getViewTemplate('template', 'post-recently-viewed', $settings);
    }
}

ElementorPlugin::instance()->widgets_manager->register(new SWE_Post_Recently_Viewed());
