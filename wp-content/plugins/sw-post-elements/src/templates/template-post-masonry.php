 ...
 */
global $wp_query;
$sweWrap = 'swe-wrap-post swe-wrap-post-masonry swe-wrapper ';
...
$sweWrapPosts = 'posts ';
if ($settings['columns']) {
	$sweWrapPosts .= ' swe-row swe-col-' . $settings['columns_mobile']['size'] . ' swe-col-md-'. $settings['columns_tablet']['size'] . ' swe-col-lg-' . $settings['columns']['size'];
}
