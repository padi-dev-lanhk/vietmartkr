...
if (class_exists('WooCommerce')) {
    final class SWE_Woo_Product_Bundles_Slider extends Widget_Base {

        /**
         * @return string
         */
        function get_name() {
            return 'swe-woo-product-bundles-slider';
        }
         ...
         */
        function get_title() {
            return esc_html__('SWE Woo Product Bundles Slider', 'sw-woo-elements');
        }
        ...
        public function register_controls() {
            ...
            */
            ...
            $this->add_control( 'title', [
                ...
                'label_block' => true,
                'default'     => __( 'Woo Product Bundles Slider', 'sw-woo-elements' ),
            ]);
            ...
            $this->add_control( 'layout', [
                ...
                'options' => [
                    ...
                    'layout-1' => __('Horizontal 2', 'sw-woo-elements'),
                ],
                'default'     => 'vertical',
            ]);
            ...
            $this->add_control('width_main_product', [
                ...
                'selectors'  => [
                    ...
                    '{{WRAPPER}} .swe-woo-products-bundles.layout-1 .item-image-bundle' => 'min-width: {{SIZE}}%;max-width: {{SIZE}}%;',
            ...
            */
            ...
            $this->add_responsive_control( 'item_bundles_col', [
        ...
        protected function render() {
            ...
            include( 'template-woo-product-bundles-slider.php' );  
        }
    }

    ElementorPlugin::instance()->widgets_manager->register(new SWE_Woo_Product_Bundles_Slider());
}
