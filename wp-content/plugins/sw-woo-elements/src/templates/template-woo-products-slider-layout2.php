<?php
/**
 * View template for SWE Tab Category Slider Layout2
 *
 * @package SWE\Templates
 * @copyright 2021 SW Elements. All rights reserved.
 */

$sweWrap = 'swe-woo-products-slider-layout2 swe-wrapper';
			...
			<ul class="products swe-slider" <?php echo $settings['slider_options']; ?>>
				<?php if( $products->have_posts() ) {
					while($products->have_posts()){ $products->the_post();
						include SWWE_PLUGIN_URL . 'src/templates/woo/layout2-item.php';
					}
					wp_reset_postdata();
				} ?>
			</ul>
