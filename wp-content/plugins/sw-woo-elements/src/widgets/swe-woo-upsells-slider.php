...
if ( class_exists('WooCommerce') ) {
    final class SWE_Woo_Upsells_Slider extends SWE_Widget_Base {
        /**
         * @return string
         */
        function get_name() {
            return 'swe-woo-upsells-slider';
        }
         ...
         */
        function get_title() {
            return esc_html__('SWE Woo Upsells Slider', 'sw-woo-elements');
        }
        ...
        protected function render() {
            ...
            $this->getViewTemplate('template', 'woo-upsells-slider', $settings);
        }
    }

    ElementorPlugin::instance()->widgets_manager->register(new SWE_Woo_Upsells_Slider());
}
