...
if (class_exists('WooCommerce')) {
    ...
    final class SWE_Woo_Filter_Tab_Slider extends SWE_Widget_Base {
        /**
         * @return string
         */
        function get_name() {
            return 'swe-woo-filter-tab-slider';
        }
         ...
         */
        function get_title() {
            return esc_html__('SWE Woo Filter Tab Slider', 'sw-woo-elements');
        }
        ...
        public function register_controls() {
            ...
            */
            ...
            $this->add_control( 'title', [
                ...
                'label_block' => true,
                'default'     => __( 'Woo Filter Tab Slider', 'sw-woo-elements' ),
            ]);
            ...
            */
            ...
            $this->add_control( 'filter', [
                'label' => __( 'Filter Tabs', 'sw-woo-elements' ),
                'type' => Controls_Manager::SELECT2,
                'multiple' => true,
                'label_block' => true,
                'options' => $this->get_woo_filter(),
            ]);
        ...
        protected function render() {
            ...
            $this->getViewTemplate('template', 'woo-filter-tab-slider', $settings);
        }
    }

    ElementorPlugin::instance()->widgets_manager->register(new SWE_Woo_Filter_Tab_Slider());
}
