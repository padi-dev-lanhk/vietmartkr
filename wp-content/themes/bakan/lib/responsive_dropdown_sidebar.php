...
class bakan_ResmenuSB{
	function __construct(){
		...
		add_action( 'wp_footer', array( $this, 'bakan_responsive_menu_footer' ) );	
	}
	...
	function bakan_responsive_menu_footer(){
						...
						<ul class="nav nav-tabs">
							...
							<?php if( has_nav_menu('primary_menu') ) : ?>
								<li class="<?php echo esc_attr( $class_p ); ?>">
									<a href="#ResPrimary" data-toggle="tab" class="tab-primary"><?php echo esc_html__( 'Menu', 'bakan' ); ?></a>
								</li>
							<?php endif; ?>
								...
								<div id="<?php echo esc_attr( 'Res'. $location ); ?>" class="tab-pane <?php echo esc_attr( ( $key == 0 ) ? 'active' : '' ); ?>">
									<?php 
										wp_nav_menu( array(
											...
											'walker' => new bakan_ResMenu_Walker()
										) );
									?>
								</div>
							<?php }
